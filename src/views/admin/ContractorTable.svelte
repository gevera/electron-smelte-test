<script>
  import { DataTable, Menu } from "smelte";
  let open = true;
  const items = [
    {
      value: 1,
  ...
  let data = [
    { name: "test 1", telephone: "4353453", quant: 3454, region: "crimea" },
    { name: "test 2", telephone: "4776634785", quant: 3454, region: "moscow" },
    { name: "test 3", telephone: "65565656", quant: 3454, region: "altai" },
    {
      name: "test 4",
